...
public class RobotContainer {
  ...
  private final SparkMaxBrushless m_testBrushless = new SparkMaxBrushless(Constants.TestBrushless.canId, Constants.TestBrushless.encoderRotationsPerFinalRotation, Constants.TestBrushless.name);
